    ...
    <div
      ...
      <div className="flex flex-col items-center mt-10 space-y-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          <div className="h-96 w-96 space-y-11 shadow-2xl flex flex-col justify-center items-center bg-transparent backdrop-blur-md bg-[#10b981] bg-opacity-60 rounded-xl">
